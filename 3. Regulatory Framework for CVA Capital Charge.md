...
In summary, the rationale for the CVA capital charge is to close the pre-crisis gap between economic risk and prudential resources, reduce procyclical feedback loops, and improve incentives to hedge and collateralize counterparty risk. The next subsection traces how Basel II first incorporated counterparty risk and why its default-only focus proved insufficient, setting the stage for Basel III’s dual treatment of default risk and CVA risk.
